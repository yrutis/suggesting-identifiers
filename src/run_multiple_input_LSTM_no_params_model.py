...
from src.trainer.Callbacks.Callback_2_inputs import Histories
...
report_folder_multiple_input = os.path.join(report_folder, 'reports-multiple-input-no-params-LSTM-' + unique_folder_key)
...
x = layers.concatenate([method_body_features, return_type_features])
...
model = keras.Model(inputs=[method_body_input, return_type_input],
