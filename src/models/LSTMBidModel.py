...
class LSTMModelBid(AbstractModel):
    def __init__(self, context_vocab_size, windows_size, config, report_folder):
        super(LSTMModelBid, self).__init__(config, report_folder)  # call parent constractor
    ...
    def build_model(self):
        ...
        logger.info("Embedding of shape {}, {}, {}".format(self.__context_vocab_size, self.config.model.embedding_dim,
                                                           self.__windows_size))
